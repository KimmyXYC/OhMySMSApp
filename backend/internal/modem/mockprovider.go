...
func NewMockProvider(log *slog.Logger) *MockProvider {
	...
	m1 := ModemState{
		...
		Registration: "home", OperatorID: "00101", OperatorName: "ExampleTel",
		OwnNumbers:   []string{"+10000000001"},
		HasSim:       true,
		SIM: &SimState{
			DBusPath:   "/org/freedesktop/ModemManager1/SIM/0",
			ICCID:      "89880000000000001234",
			IMSI:       "001010000000001",
			MSISDN:     "+10000000001",
			OperatorID: "00101", OperatorName: "ExampleTel",
	...
	m2 := ModemState{
		...
		Registration: "roaming", OperatorID: "90128", OperatorName: "ExampleRoam",
		HasSim:       true,
		SIM: &SimState{
			DBusPath:   "/org/freedesktop/ModemManager1/SIM/1",
			ICCID:      "89490000001234567890",
			IMSI:       "901280000000002",
			EID:        "89049000000000000000000000000000",
			MSISDN:     "+10000000002",
			OperatorID: "90128", OperatorName: "ExampleRoam",
